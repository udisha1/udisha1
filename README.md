...
- Competitive programming (LeetCode, CF)
- Building & shipping full-stack apps
- Open source (GSSoC contributor + admin)
```
...
[★] NPTEL Elite (2025) ......... IIT Kharagpur — Programming in Java / DSA
```
